var config = {
    apiKey: "AIzaSyBh8x0YS1aLsLVkBzOHBYLG-M65uPvf0Y0",
    authDomain: "train-scheduler-14b53.firebaseapp.com",
    databaseURL: "https://train-scheduler-14b53.firebaseio.com",
    projectId: "train-scheduler-14b53",
    storageBucket: "",
    messagingSenderId: "1051343306022"
};
...
database.ref().on("child_added", function (childSnapshot) {
    ...
    $("#train-scheduler").append("<tr><td>" + trainName + "</td><td>" + destination + "</td><td>" + nxTrain + "</td><td>" + frequency + "</td><td>" + minToTrain + "</td></tr>");
});